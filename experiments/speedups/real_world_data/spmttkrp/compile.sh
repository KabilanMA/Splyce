#!/usr/bin/env bash
# compile.sh — Compile spmttkrp_dn.mlir (this directory) into two binaries: a plain
...
#   ./test_benchmark_spmttkrp_scf[_parallel]
#   ./test_benchmark_spmttkrp_splyce_phase_001[_parallel]
#
