#!/usr/bin/env bash
# compile.sh — Compile spmspv.mlir (this directory) into one Splyce-
...
#   ./test_benchmark_spmspv_scf
#   ./test_benchmark_spmspv_splyce_phase_<XYZ>
#   ./test_benchmark_spmspv_splyce_phase_<XYZ>_fastmath
#
