#!/usr/bin/env bash
# compile.sh — Compile spmttkrp_dn.mlir (this directory) into one Splyce-
...
#   ./test_benchmark_spmttkrp_scf
#   ./test_benchmark_spmttkrp_splyce_phase_<XYZ>
#   ./test_benchmark_spmttkrp_splyce_phase_<XYZ>_fastmath
#
